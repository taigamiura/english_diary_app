...
class SubscriptionRepository {
  ...
  SubscriptionRepository({ApiRepository? apiRepository})
      ...
      logRequestResponse(
        ...
        () async {
          ...
          return List<Map<String, dynamic>>.from(
            result,
          ).map((json) => Subscription.fromJson(json)).toList();
        },
        requestDetail: 'profileId: $profileId',
      );

  Future<Subscription?> fetchSubscription(int id) =>
      logRequestResponse('SubscriptionRepository.fetchSubscription', () async {
  ...
  Future<void> deleteSubscription(int id) => logRequestResponseVoid(
