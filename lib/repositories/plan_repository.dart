...
class PlanRepository {
  ...
  PlanRepository({ApiRepository? apiRepository})
    : apiRepository = apiRepository ?? ApiRepository();

  Future<List<Plan>> fetchPlans() =>
      logRequestResponse('PlanRepository.fetchPlans', () async {
        var query = apiRepository.client.from(table).select();
        final result = await query;
        return List<Map<String, dynamic>>.from(
          result,
        ).map((json) => Plan.fromJson(json)).toList();
      });

  Future<Plan?> fetchPlan(int id) =>
      logRequestResponse('PlanRepository.fetchPlan', () async {
  ...
  Future<void> insertPlan(Plan plan) =>
      logRequestResponseVoid('PlanRepository.insertPlan', () async {
  ...
  Future<void> updatePlan(int id, Plan plan) =>
      logRequestResponseVoid('PlanRepository.updatePlan', () async {
  ...
  Future<void> deletePlan(int id) =>
      logRequestResponseVoid('PlanRepository.deletePlan', () async {
