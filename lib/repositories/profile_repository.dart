...
class ProfileRepository {
  ...
  ProfileRepository({ApiRepository? apiRepository})
    : apiRepository = apiRepository ?? ApiRepository();

  Future<List<app_model.Profile>> fetchProfiles() =>
      logRequestResponse('ProfileRepository.fetchProfiles', () async {
        var query = apiRepository.client.from(table).select();
        final result = await query;
        return List<Map<String, dynamic>>.from(
          result,
        ).map((json) => app_model.Profile.fromJson(json)).toList();
      });

  Future<app_model.Profile?> fetchProfile(String id) =>
      logRequestResponse('ProfileRepository.fetchProfile', () async {
  ...
  Future<void> insertProfile(app_model.Profile profile) =>
      logRequestResponseVoid('ProfileRepository.insertProfile', () async {
  ...
  Future<void> updateProfile(String id, app_model.Profile profile) =>
      logRequestResponseVoid('ProfileRepository.updateProfile', () async {
  ...
  Future<void> deleteProfile(String id) =>
      logRequestResponseVoid('ProfileRepository.deleteProfile', () async {
