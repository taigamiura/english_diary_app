...
class AuthRepository {
  ...
  Future<AuthResponse> signUpWithEmail() => logRequestResponse(
  ...
  Future<AuthResponse> signInWithEmail() => logRequestResponse(
  ...
  Future<AuthResponse> signInWithGoogle() =>
      logRequestResponse('AuthRepository.signInWithGoogle', () async {
  ...
  Future<void> signOut() =>
      logRequestResponseVoid('AuthRepository.signOut', () async {
