...
class ApiRepository {
  ...
  Future<Map<String, dynamic>?> fetchOne({
    ...
    required String id,
    String idColumn = 'id',
  }) => logRequestResponse('ApiRepository.fetchOne', () async {
  ...
  }) => logRequestResponseVoid('ApiRepository.insertOne', () async {
    await client.from(table).insert(data);
  ...
  Future<void> updateOne({
    ...
    required Map<String, dynamic> data,
    String idColumn = 'id',
  }) => logRequestResponseVoid('ApiRepository.updateOne', () async {
  ...
  Future<void> deleteOne({
    ...
    required String id,
    String idColumn = 'id',
  }) => logRequestResponseVoid('ApiRepository.deleteOne', () async {
    await client.from(table).delete().eq(idColumn, id);
  }, requestDetail: 'table: $table, id: $id');

  /// ユーザーのログイン
  Future<void> login() =>
      logRequestResponseVoid('ApiRepository.login', () async {
        if (kDebugMode) {
  ...
  Future<void> _signInWithGoogle() =>
      logRequestResponseVoid('ApiRepository._signInWithGoogle', () async {
  ...
  Future<void> _signInWithEmail() =>
      logRequestResponseVoid('ApiRepository._signInWithEmail', () async {
