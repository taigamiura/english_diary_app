...
class AiCorrectionServiceImpl implements AiCorrectionService {
  ...
  @override
  Future<List<AiCorrection>> fetchAiCorrections({required String diaryEntryId}) => repository.fetchAiCorrections(diaryEntryId: diaryEntryId);

  @override
  Future<AiCorrection?> fetchAiCorrection(String id) => repository.fetchAiCorrection(id);

  @override
  Future<void> insertAiCorrection(AiCorrection correction) => repository.insertAiCorrection(correction);

  @override
  Future<void> updateAiCorrection(String id, AiCorrection correction) => repository.updateAiCorrection(id, correction);

  @override
  Future<void> deleteAiCorrection(String id) => repository.deleteAiCorrection(id);
}
